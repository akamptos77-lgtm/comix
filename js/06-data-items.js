'use strict';
/* 06-DATA-ITEMS: предметы (элементальное оружие
на все стихии у каждого героя), дроп по классу */
var CURSED_ITEMS=[
...
/* === ГЕНЕРАТОР ЭЛЕМЕНТАЛЬНОГО ОРУЖИЯ === */
var EW_NAMES={fire:'Пламенный',ice:'Ледяной',lightning:'Грозовой',poison:'Ядовитый',holy:'Священный',dark:'Тёмный'};
var EW_NOUN={knight:'меч',mage:'посох',rogue:'кинжал',barbarian:'топор',inventor:'мушкет',archer:'лук',fairy:'жезл'};
var EW_ICON={knight:'⚔️',mage:'🔮',rogue:'🗡️',barbarian:'🪓',inventor:'🔫',archer:'🏹',fairy:'✨'};
function elementalWeapons(){
  var out=[],els=['fire','ice','lightning','poison','holy','dark'];
  Object.keys(EW_NOUN).forEach(function(cls){
    els.forEach(function(el,idx){
      var rar=(idx%2)+1;
      out.push({slot:'weapon',i:EW_ICON[cls],n:EW_NAMES[el]+' '+EW_NOUN[cls],
        rar:rar,f:3,el:el,cls:[cls],
        b:{atk:4+rar*3,crit:2+rar*2}});
    });
  });
  return out;
}
...
{slot:'weapon',i:'⚔️',n:'Клинок бастиона',rar:2,f:7,b:{atk:9,crit:4},cls:['knight']},
{slot:'weapon',i:'🌿',n:'Дубовый посох',rar:0,f:1,b:{atk:2,crit:2},cls:['mage']},
{slot:'weapon',i:'🔮',n:'Посох молний',rar:1,f:3,b:{atk:4,crit:4},cls:['mage']},
{slot:'weapon',i:'🔮',n:'Посох архимага',rar:2,f:7,b:{atk:8,crit:6},cls:['mage']},
...
{slot:'weapon',i:'🗡️',n:'Клинки тени',rar:2,f:7,b:{atk:7,crit:8},cls:['rogue']},
...
{slot:'weapon',i:'🔫',n:'Гаусс-пушка',rar:2,f:7,b:{atk:10,crit:7},cls:['inventor']},
...
{slot:'weapon',i:'🏹',n:'Лук небес',rar:2,f:7,b:{atk:9,crit:8},cls:['archer']},
{slot:'weapon',i:'✨',n:'Волшебная палочка',rar:0,f:1,b:{atk:2,crit:3},cls:['fairy']},
{slot:'weapon',i:'✨',n:'Жезл сияния',rar:1,f:3,b:{atk:4,crit:4},cls:['fairy']},
{slot:'weapon',i:'✨',n:'Скипетр зари',rar:2,f:7,b:{atk:8,crit:7},cls:['fairy']},
/* Броня по классам */
{slot:'armor',i:'🛡️',n:'Кольчуга',rar:0,f:1,b:{def:3},cls:['knight','barbarian']},
{slot:'armor',i:'🛡️',n:'Латы рыцаря',rar:1,f:3,b:{def:5,hp:10},cls:['knight','barbarian']},
{slot:'armor',i:'🛡️',n:'Латы бастиона',rar:2,f:7,b:{def:9,hp:25},cls:['knight','barbarian']},
{slot:'armor',i:'👘',n:'Холщовая мантия',rar:0,f:1,b:{def:1,crit:2},cls:['mage','fairy']},
{slot:'armor',i:'👘',n:'Шёлковая роба',rar:1,f:3,b:{def:2,crit:5},cls:['mage','fairy']},
{slot:'armor',i:'👘',n:'Мантия архимага',rar:2,f:7,b:{def:4,crit:8,hp:20},cls:['mage','fairy']},
{slot:'armor',i:'🧥',n:'Кожаный плащ',rar:0,f:1,b:{def:2,dodge:3},cls:['rogue','archer','inventor']},
{slot:'armor',i:'🧥',n:'Маскировочный плащ',rar:1,f:3,b:{def:3,dodge:6},cls:['rogue','archer','inventor']},
{slot:'armor',i:'🧥',n:'Плащ убийцы',rar:2,f:7,b:{def:5,dodge:9,crit:3},cls:['rogue','archer','inventor']},
/* Шлемы по классам */
{slot:'helmet',i:'⛑️',n:'Стальной шлем',rar:1,f:3,b:{def:3,hp:10},cls:['knight','barbarian']},
{slot:'helmet',i:'⛑️',n:'Рогатый шлем',rar:2,f:7,b:{def:5,hp:20,atk:2},cls:['knight','barbarian']},
{slot:'helmet',i:'🎩',n:'Остроконечная шляпа',rar:1,f:3,b:{def:1,crit:4},cls:['mage','fairy']},
...
{slot:'boots',i:'👟',n:'Лёгкие туфельки',rar:1,f:3,b:{dodge:5,crit:2},cls:['fairy','mage']},
{slot:'boots',i:'👢',n:'Ботинки тени',rar:2,f:7,b:{dodge:7,spd:3,crit:2},cls:['rogue','archer','inventor']},
/* Перчатки по классам */
{slot:'gloves',i:'🧤',n:'Латные рукавицы',rar:1,f:3,b:{atk:2,def:2},cls:['knight','barbarian']},
{slot:'gloves',i:'🧤',n:'Шёлковые перчатки',rar:1,f:3,b:{atk:2,crit:3},cls:['mage','fairy']},
{slot:'gloves',i:'🧤',n:'Перчатки точности',rar:2,f:7,b:{atk:3,crit:6},cls:['rogue','archer','inventor']},
/* Универсальные (кольца/амулеты) */
