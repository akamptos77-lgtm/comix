...
{id:'bat',name:'Пещерный Нетопырь',tier:1,hp:30,atk:10,def:1,spd:12,crit:6,gold:14,xp:20,tr:'swift',ai:'swift',el:'dark',weak:'ice',resist:'dark',desc:'Мечется в темноте.',mat:'Крыло мыши'},
{id:'goblin',name:'Гоблин-Громила',tier:1,hp:46,atk:11,def:3,spd:6,crit:4,gold:16,xp:24,ai:'melee',el:'physical',weak:'fire',resist:null,desc:'Тупой, но злой.',mat:'Гоблинское ухо'},
{id:'skeleton',name:'Костяной Воин',tier:2,hp:60,atk:14,def:6,spd:6,crit:5,gold:22,xp:32,tr:'armor',ai:'tank',el:'dark',weak:'fire',resist:'physical',desc:'Кости крепки, но огонь жжёт.',mat:'Костяная пыль'},
...
{id:'zombie',name:'Гниющий Зомби',tier:2,hp:75,atk:15,def:4,spd:4,crit:4,gold:26,xp:36,tr:'rage',ai:'tank',el:'poison',weak:'poison',resist:'poison',desc:'Медленный, но живучий.',mat:'Гнилая плоть'},
...
{id:'hgoblin',name:'Гоблин-Налётчик',tier:3,hp:80,atk:18,def:6,spd:7,crit:6,gold:32,xp:42,tr:'rage',ai:'melee',el:'physical',weak:'ice',resist:null,desc:'Крупнее обычного гоблина.',mat:'Гоблинское ухо'},
...
{id:'toad',name:'Болотная Жаба',tier:5,hp:100,atk:24,def:7,spd:6,crit:6,gold:44,xp:56,tr:'venom',ai:'caster',el:'poison',weak:'poison',resist:'poison',desc:'Раздутая и ядовитая.',mat:'Болотная слизь'},
{id:'bog',name:'Трясинный Ходулочник',tier:5,hp:115,atk:25,def:8,spd:5,crit:6,gold:46,xp:58,tr:'rage',ai:'tank',el:'poison',weak:'poison',resist:'poison',desc:'Бродит по трясине.',mat:'Трясинный мох'},
{id:'snake',name:'Ядовитый Полоз',tier:5,hp:95,atk:26,def:6,spd:12,crit:10,gold:48,xp:60,tr:'venom',ai:'caster',el:'poison',weak:'poison',resist:'poison',desc:'Клыки полны яда.',mat:'Змеиная чешуя'},
...
{id:'harpy',name:'Свистящая Гарпия',tier:6,hp:110,atk:29,def:7,spd:15,crit:12,gold:52,xp:66,tr:'swift',ai:'swift',el:'lightning',weak:'lightning',resist:'lightning',desc:'Пикирует с неба.',mat:'Коготь гарпии'},
...
{id:'voidguard',name:'Страж Пустоты',tier:10,hp:210,atk:44,def:14,spd:8,crit:10,gold:100,xp:124,tr:'armor',ai:'tank',el:'dark',weak:'lightning',resist:'dark',desc:'Страж границы миров.',mat:'Пустотный камень'},
{id:'voidkeeper',name:'Хранитель Бездны',tier:10,hp:195,atk:46,def:11,spd:11,crit:13,gold:102,xp:126,tr:'venom',ai:'caster',el:'dark',weak:'ice',resist:'dark',desc:'Шепчет на забытых языках.',mat:'Шёпот бездны'},
{id:'chaos',name:'Аватар Хаоса',tier:10,hp:230,atk:46,def:13,spd:10,crit:12,gold:106,xp:130,tr:'rage',ai:'caster',el:'dark',weak:'fire',resist:'dark',desc:'Воплощение разрушения.',mat:'Осколок хаоса'}
];
var BOSSES={
...
100:{id:'worlddevourer',name:'Пожиратель Миров',hp:520,atk:60,def:18,spd:12,crit:16,gold:1200,xp:800,tr:'rage',ai:'caster',el:'dark',weak:null,resist:'dark',final:true,desc:'Конец всего. Не имеет слабостей.',mat:'Осколок мира'}
};
var ALL_MONSTERS=ENEMY_POOL.concat(Object.values(BOSSES));
var TR_LBL={swift:'⚡ ловкий',armor:'🛡️ бронированный',rage:'😡 ярость',venom:'☠️ ядовитый'};
