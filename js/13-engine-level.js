...
ФИКС: имя берётся из второй БД (не из поля ввода)
============================================ */
...
/**
 * ПОКАЗЫВАЕТ МОДАЛКУ КОНЦА ЗАБЕГА (победа/поражение).
 * ИМЯ БЕРЁТСЯ ИЗ ВТОРОЙ БД (не из поля ввода).
 */
...
// === ИЗМЕНЕНИЕ: вместо поля ввода показываем имя из второй БД ===
var inp = $('#end-inp');
if (inp) {
    // Скрываем поле ввода — имя теперь берётся автоматически
    inp.style.display = 'none';
    inp.value = '';
}

// Показываем имя из второй БД (если есть контейнер)
var nameDisplay = $('#end-name-display');
if (nameDisplay) {
